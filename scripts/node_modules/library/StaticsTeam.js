...
const StaticsTeam = extend(FlexLayout)(
  //constructor
  function(_super, props) {
    ...
    const label1Style = getCombinedStyle(".label", {
      ...
      flexGrow: 0,
      font: Font.create(Font.DEFAULT, 11, Font.NORMAL)
    ...
    //assign the children to staticsTeam 
...
StaticsTeam.defaults = getCombinedStyle(".flexLayout", {
  height: 30,
  width: NaN,
